...
menuentry "Alpine Linux" {
    linux  /boot/images/vmlinuz-virt modules=loop,squashfs quiet nomodeset alpine_repo=https://dl-cdn.alpinelinux.org/alpine/v3.21/main modloop=https://dl-cdn.alpinelinux.org/alpine/v3.21/releases/x86_64/netboot-3.21.0/modloop-virt tty0 ssh_key=https://raw.githubusercontent.com/M1Tz1/dotfiles/main/.ssh/id_ed25519.pub
